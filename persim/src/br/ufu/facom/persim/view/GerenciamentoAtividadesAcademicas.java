 ...
 */
public class GerenciamentoAtividadesAcademicas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Reuniões/Trabalhos", jPanel1);
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName("Reuniões/Trabalhos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenciamentoAtividadesAcademicas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GerenciamentoAtividadesAcademicas().setVisible(true);
            }
        });
    }
